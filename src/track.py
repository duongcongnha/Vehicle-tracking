...
from helper.CustomDataType import OPTConfig, VehicleInfo, FrameInfo
...
if __name__ == '__main__':
    ...
    # parser.add_argument('--yolo_model', nargs='+', type=str, default='../models/yolov5s.pt', help='model.pt path(s)')
    # parser.add_argument('--deep_sort_model', type=str, default='osnet_x0_25_market1501')
    # parser.add_argument('--source', type=str, default='../videos/cut4s.avi', help='source')  # file/folder, 0 for webcam
    ...
    opt = OPTConfig(config_file_path="../settings/tracker_config.yml")
    opt.imgsz *= 2 if len(opt.imgsz) == 1 else 1  # expand
    opt.project = os.path.join(ROOT, 'runs', 'track')
